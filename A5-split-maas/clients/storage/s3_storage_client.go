...
func newS3StorageClient(storageConfig domain.StorageConfig) (Client, error) {
	// BUCKET_NAME  = "graphless-graph-file-bucket"
	// BUCKET_KEY  = "graphFileKey"
	// region = "us-east-2"
	sess := session.Must(session.NewSession(&aws.Config{Region: aws.String(storageConfig.Region)}))
